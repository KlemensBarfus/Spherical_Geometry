...
import numpy as np
import math
from great_circles_intersections import great_circles_intersections
...
def arc_intersection_great_circles(lat1a,lon1a,lat1b,lon1b,lat2a,lon2a,lat2b,lon2b,radius=6371.0):
  r = radius

  lat1_res, lon1_res, lat2_res, lon2_res = great_circles_intersections(lat1a,lon1a,lat1b,lon1b,lat2a,lon2a,lat2b,lon2b,radius=r)

  x1a,y1a,z1a = spherical_to_xyz(lat1a,lon1a,r)
  x1b,y1b,z1b = spherical_to_xyz(lat1b,lon1b,r)
  i1a,i1b,i1c = spherical_to_xyz(lat1_res,lon1_res,r)
  ...
  if(test_score < eps):
    ...
    if(test_score < eps):
      ...
      found = True
  if(found == False):
    i2a,i2b,i2c = spherical_to_xyz(lat2_res,lon2_res,r)
